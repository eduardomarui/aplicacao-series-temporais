...
# ------------------------------------------------------------------
# Carrega dados históricos da PETR4 exportados do investing.com
...
for seq_length in seq_lengths_to_test:
    ...
    for t in range(total_steps):
        ...
        for epoch in range(epochs):
            ...
            for batch_X, batch_y in dataloader:
                ...
                loss = criterion(output.squeeze(), batch_y)  # calcula perda
    ...
    ax.set_title(
        f'TCN Rolling Forecast: {seq_length} dias → 3 à frente\n'
    ...
    filename_dots = f'tcn_rolling_{seq_length}dias_bolinhas.png'
...
for seq_length in seq_lengths_to_test:
    print(f"  📍 tcn_rolling_{seq_length}dias_bolinhas.png")
    print(f"  📈 tcn_rolling_{seq_length}dias_linhas.png")

# Gerar tabela Excel com médias a cada 3 dias
print("\n📊 Gerando tabela Excel com médias a cada 3 dias...")

# Criar uma data base hipotética (1 de março de 2025)
data_base = datetime(2025, 3, 1)

# Criar o arquivo Excel com múltiplas abas
excel_filename = 'tcn_previsoes_medias_3dias.xlsx'
